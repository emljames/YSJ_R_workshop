...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, 'setup.html'))})
output: 
  html_document:
    toc: true
    toc_float:
...
You will need to have R and R Studio to installed to follow along with the workshop. R is the programming language itself, whereas RStudio is the user interface for interacting with R.  
...
Finally, please fill out [this short anonymous survey](https://docs.google.com/forms/d/e/1FAIpQLScMYWoy0yHa1MUnMqksYW_XiCi9SwnwmExbgEfC2_G6RiLoZQ/viewform?usp=sf_link) to let us know your previous experience and what you hope to gain from the workshop. 